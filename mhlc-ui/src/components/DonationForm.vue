    ...
    <v-tabs-window v-model="tab">
      <v-tabs-window-item :value="1">
        <v-container>
          ...
          <v-alert>
            <p class="instructions">
              Use the form below to make either a one-time or recurring donation. Payments are processed through PayPal, however, if you don't have a PayPal account, you can use your credit card.
            </p>
          ...
          <v-alert
            v-if="paypalDonation.validationResult && !paypalDonation.validationResult.valid"
            type="error"
          >
      ...
      <v-tabs-window-item :value="2">
        <v-container>
          ...
          <v-alert>
            <p class="instructions">
              Use the "Donate" button below to be directed to the Tithe.ly donation form.
            </p>
          </v-alert>
