    ...
    <v-main>
      <v-container class="main-container fill-height">
        <v-row class="justify-center fill-height">
          <v-col class="cemetery-main-container">
            <router-view />
          </v-col>
        </v-row>
      </v-container>
...
<style>
    ...
    .v-container.main-container > .v-row > .v-col.cemetery-main-view { max-width: 1000px; }
    .v-container.main-container > .v-row > .v-col.cemetery-main-view.xxs { max-width: 375px; }
    .v-container.main-container > .v-row > .v-col.cemetery-main-view.xs { max-width: 425px; }
    .v-container.main-container > .v-row > .v-col.cemetery-main-view.sm { max-width: 570px; }
    .v-container.main-container > .v-row > .v-col.cemetery-main-view.md { max-width: 850px; }
